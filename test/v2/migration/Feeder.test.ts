...
const CMARS_DAI_V1 = '0xCMARSCMARSCMARSCMARSCMARSCMARSCMARSCMARS1';
const CMARS_DAI_V1_BAL = ETH.mul(10000);
const SMARS_DAI_V1 = '0xCMARSCMARSCMARSCMARSCMARSCMARSCMARSCMARS2';
const SMARS_DAI_V1_BAL = ETH.mul(20000);
...
describe('Feeder', () => {
  ...
  beforeEach('deploy contracts', async () => {
    ...
    await shareV1.connect(operator).mint(CMARS_DAI_V1, CMARS_DAI_V1_BAL);
    await shareV1.connect(operator).mint(SMARS_DAI_V1, SMARS_DAI_V1_BAL);
    ...
    await shareV2PoolStore
      .connect(operator)
      .addPool('SMARSv2 Pool', shareV2.address, 1);
    await shareV2PoolStore
      .connect(operator)
      .addPool('SMARSv2 LP Pool', shareV2LP.address, 0);
